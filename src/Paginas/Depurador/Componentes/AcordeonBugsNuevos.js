...
function AcordeonBugsNuevos() {
  ...
  return (
    <>
      <Accordion
        className="acordeon-bugs-nuevos"
                ...
                <Accordion.Body>
                  ...
                  <div>
                    <Button
                      ...
                      onClick={() => handleAceptarBug(list.id)}
                    >
                      Aceptar Bug
                    </Button>
                    <Rechazar
                      className="rechazo-lugar"
                      onRechazoCompletado={handleRechazoCompletado}
                      reporteId={list.id}
                    ></Rechazar>
                  </div>
                </Accordion.Body>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>
            Bug aceptado
            <span role="img" aria-label="Emoticono Sonriente">
              {" "}
              😊
            </span>
            <span role="img" aria-label="Emoticono Pulgar Arriba">
              👍
            </span>
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>¡El bug ha sido aceptado con éxito!</Modal.Body>
        <Modal.Footer>
