...
const ReasignacionDepurador = () => {
  ...
  let { reporte, proyecto, depuradores, usuario, SetIDReporte, depurador } =
        ...
        <Row>
          ...
          >
            ...
            <div>
              ...
              >
                <Modal.Header closeButton>
                  <Modal.Title>Reasignación rechazada</Modal.Title>
                </Modal.Header>
                <Modal.Body>Se ha devuelto el bug al depurador</Modal.Body>
                <Modal.Footer>
                  <Button
                    variant="secondary"
              ...
              >
                ...
                <Modal.Body>
                  <Container className="cards-container">
                    <DynamicCard
                      listadeDepuradores={depuradores.filter(
                        (dep) => dep.nombre !== depurador.nombre
                      )}
              ...
              <Modal
                ...
                onHide={() => setShowModalReasignar(false)}
              >
                <Modal.Header closeButton>
                  <Modal.Title>Depurador reasignado con éxito</Modal.Title>
                </Modal.Header>
                <Modal.Body>El depurador se ha reasignado con éxito</Modal.Body>
                <Modal.Footer>
                  <Button
                    variant="secondary"
                    onClick={() => handleModalCloseReasignar()}
                  >
                    Cerrar
                  </Button>
                </Modal.Footer>
